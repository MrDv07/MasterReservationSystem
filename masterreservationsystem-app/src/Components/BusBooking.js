...
export const BusBooking = () => {
    ...
    const [booking, setbooking ] = useState({
      ...
      const saveBooking = (e) => {
        e.preventDefault();
        BusBookingService.savedBooking(booking)
         .then((response)=>{
    ...
    <div className="flex max-w-2xl mx-auto shadow border-b">
        <div className="px-8 py-8">
            <div className="text-2xl">
                <h1 className="font-serif">Bus Booking</h1>
            </div>
            ...
            <div className='items-center justify-center h-14 w-full my-4 '>
                <label className='block text-gray-600 text-sm font-normal'>Number Of Bus</label>
                <input type="number" 
                name='numberOfMode' 
