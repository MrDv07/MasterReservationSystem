    ...
    <div className='flex shadow border-b max-w-full mx-auto'>
          <table className='min-w-full my-32'>
            ...
            {loading ? (
              ...
              train.map((train) => (
              <tr key={train.id}>
                <td className='text-left px-6 py-2 whitespace-nowrap text-xs text-white'>{train.id}</td>
                <td className='text-left px-6 py-2 whitespace-nowrap text-xs text-white'>{train.trainName}</td>
                <td className='text-left px-6 py-2 whitespace-nowrap text-xs text-white'>{train.source}</td>
                <td className='text-left px-6 py-2 whitespace-nowrap text-xs text-white'>{train.destination}</td>
                <td className='text-left px-6 py-2 whitespace-nowrap text-xs text-white'>{train.hoursOfJourney}</td>
                <td className='text-left px-6 py-2 whitespace-nowrap text-xs text-white'>{train.numberOfStops}</td>
                <td className='text-left px-6 py-2 whitespace-nowrap text-xs text-white'>{train.fareOfSleeperClass}</td>
                <td className='text-left px-6 py-2 whitespace-nowrap text-xs text-white'>{train.fareOf1Ac}</td>
                <td className='text-left px-6 py-2 whitespace-nowrap text-xs text-white'>{train.fareOf2Ac}</td>
                <td className='text-left px-6 py-2 whitespace-nowrap text-xs text-white'>{train.fareOf3Ac}</td>
